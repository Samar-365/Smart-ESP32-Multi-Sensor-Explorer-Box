/**
 * Submodule 8.2: Production ESP32 Arduino C++ Firmware Sketch Reference
 * Provides firmware source code, compilation guidelines, and required library manifests.
 * Fulfills SRS Section 24 (Architecture) & Section 28 (Data Structure).
 */

export const REQUIRED_LIBRARIES = [
  { name: 'WiFi', builtIn: true, description: 'ESP32 Core Wi-Fi library' },
  { name: 'HTTPClient', builtIn: true, description: 'ESP32 Core HTTP client for REST POST' },
  { name: 'Wire', builtIn: true, description: 'I2C master library for BME280' },
  { name: 'Adafruit Unified Sensor', version: '^1.1.14', description: 'Sensor abstraction layer' },
  { name: 'Adafruit BME280 Library', version: '^2.2.4', description: 'Digital humidity, pressure, and temperature driver' },
  { name: 'ArduinoJson', version: '^6.21.4', description: 'High-performance JSON serialization for telemetry packets' }
];
